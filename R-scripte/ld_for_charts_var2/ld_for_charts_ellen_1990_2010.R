...
current_dir<-"/grid/USF/kynast/WorldQual_workspace/WorldQual/R-scripte/ld_for_charts_var2"
output_csv<-"/grid/USF/kynast/WorldQual_workspace/WorldQual/R-scripte/ld_for_charts_var2/UNEP"
setwd(current_dir)
