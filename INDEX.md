# WorldQual - Dokumentations-Übersicht
...
- [Installation](README.md#installation) - System einrichten

### Nutzung
- [Kompletter Workflow](DOCUMENTATION.md#erste-schritte---kompletter-workflow) - Schritt-für-Schritt
- [Module im Detail](DOCUMENTATION.md#module-im-detail) - Was macht jedes Modul?
- [Konfiguration](DOCUMENTATION.md#konfiguration-verstehen) - OPTIONS.DAT verstehen

### Praktische Hilfe
- [Praktische Beispiele](DOCUMENTATION.md#praktische-beispiele) - Konkrete Anwendungsfälle
- [Fehlerbehebung](DOCUMENTATION.md#fehlerbehebung) - Probleme lösen
- [Tipps und Tricks](DOCUMENTATION.md#tipps-und-tricks) - Best Practices

### Referenz
- [Wichtige Nummern](QUICK_REFERENCE.md#wichtige-nummern) - Parameter-IDs, Region-IDs
- [Datenbank-Abfragen](QUICK_REFERENCE.md#datenbank-abfragen) - SQL-Beispiele
- [Häufige Befehle](QUICK_REFERENCE.md#häufige-befehle) - Command-Reference
...
2. [Konfiguration vorbereiten](DOCUMENTATION.md#schritt-1-projekt-und-szenario-prüfen)
3. [Einträge berechnen](DOCUMENTATION.md#schritt-3-einträge-berechnen)
4. [Hauptsimulation ausführen](DOCUMENTATION.md#schritt-5-hauptsimulation)

### Workflow 2: Ergebnisse analysieren
1. [Statistik ausführen](DOCUMENTATION.md#schritt-7-statistik-vergleich-mit-messungen)
2. [Visualisierung erstellen](DOCUMENTATION.md#schritt-8-visualisierung)

### Workflow 3: Szenarienvergleich
1. [Mehrere Szenarien simulieren](DOCUMENTATION.md#beispiel-3-szenarienvergleich)
2. [Vergleich durchführen](DOCUMENTATION.md#wq_stat_scen---szenarienvergleich)
...
- [Datenbank-Abfragen](QUICK_REFERENCE.md#datenbank-abfragen)
- [OPTIONS.DAT Einstellungen](QUICK_REFERENCE.md#optionsdat---wichtige-einstellungen)
- [Fehlerbehebung](QUICK_REFERENCE.md#fehlerbehebung---schnell)
...
- **Detaillierte Fragen:** Siehe [DOCUMENTATION.md](DOCUMENTATION.md)
- **Projektstruktur:** Siehe [STRUCTURE.md](STRUCTURE.md)

---

**Hinweis:** Alle Links funktionieren auf GitHub automatisch durch Klick!
