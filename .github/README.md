...
- **...zum ersten Mal nutzen** → [README.md - Schnellstart](../README.md#schnellstart-quick-start)
- **...eine Simulation durchführen** → [DOCUMENTATION.md - Workflow](../DOCUMENTATION.md#erste-schritte---kompletter-workflow)
- **...schnell etwas nachschlagen** → [QUICK_REFERENCE.md](../QUICK_REFERENCE.md)
- **...ein Problem lösen** → [DOCUMENTATION.md - Fehlerbehebung](../DOCUMENTATION.md#fehlerbehebung)

---

**Hinweis:** Alle Links funktionieren auf GitHub durch Klick!
