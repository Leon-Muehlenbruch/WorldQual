...
**Navigation:** [Übersicht](../index.md) | [Schnellreferenz](schnellreferenz.md) | [Detaillierte Anleitung](anleitung.md) | [Index](../index.md)
...
**Hinweis:** Diese Strukturübersicht dient als Referenz. Für detaillierte Informationen siehe [DOCUMENTATION.md](anleitung.md).
